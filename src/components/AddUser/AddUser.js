...
import { FormControl, TextField, Typography, Grid, Box, FormHelperText, IconButton } from '@material-ui/core';
...
const AddUser = ({ isOpen, onClose, onSuccess }) => {
	...
	const phoneNumberIsValid = Validate.isNotEmpty(phoneNumber) && Validate.isPhoneNumber(phoneNumber);
	...
	const formIsValid =
		emailIsValid && phoneNumberIsValid && passwordIsValid && confirmPasswordIsValid && fullNameIsValid;
